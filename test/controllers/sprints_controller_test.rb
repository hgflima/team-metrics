...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { description: @sprint.description, project_id: @sprint.project_id, title: @sprint.title }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { description: @sprint.description, project_id: @sprint.project_id, title: @sprint.title }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
